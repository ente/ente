...
Share debug logs with [support@ente.com](mailto:support@ente.com) so we can identify the specific file. Open `Settings > Help & Support > Report an issue` and attach to email.
