...
| 2 | 2.1 | Add dependency, test, analysis, and optional platform-build gates | M | 🟡 working | Run deterministic submodule/dependency/generation checks, the focused self-hosted suites, tracked-source formatting, full mobile analysis, and opt-in Android debug/iOS Simulator builds against a public example endpoint. Stop on the first failure and never reinterpret failure as success. |
